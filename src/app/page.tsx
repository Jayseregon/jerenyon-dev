...
export default function RootPage() {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden grid grid-rows-[minmax(0,2fr)_minmax(0,1fr)] sm:grid-rows-[minmax(0,1fr)_minmax(0,auto)] border-2">
      {/* Parallax Image */}
      <div className="row-span-1 max-h-[70vh] border-2 mt-16">
        <ParallaxImage
          height="100%"
      ...
      <div className="flex flex-col-reverse items-center justify-end pb-5 border-2">
        ...
        <div className="text-center w-full max-w-full my-2 overflow-hidden">
          <h3 className="text-purple-800 dark:text-purple-300 text-sm sm:text-base border-2">
            {t("hero.subtitle")}
          </h3>
        </div>
      </div>
