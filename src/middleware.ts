...
function cspMiddleware(req: NextRequest): NextResponse {
  ...
  script-src 'self' 'nonce-${nonce}' 'strict-dynamic' blob: https://jerenyon.dev https://www.jerenyon.dev https://*.jerenyon.dev https://www.google.com https://www.gstatic.com https://app.termageddon.com https://privacy-proxy.usercentrics.eu https://app.usercentrics.eu https://vercel.live https://vercel.live/_next-live/feedback;
  style-src 'self' 'nonce-${nonce}' 'strict-dynamic' https://jerenyon.dev https://www.jerenyon.dev https://*.jerenyon.dev https://app.termageddon.com https://vercel.live;
  img-src 'self' 'strict-dynamic' blob: data: https://jerenyon.dev https://www.jerenyon.dev https://*.jerenyon.dev https://jerenyon-dev-cdn.b-cdn.net https://app.usercentrics.eu;
