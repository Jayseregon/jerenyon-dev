...
function cspMiddleware(req: NextRequest): NextResponse {
  ...
  script-src 'self' 'nonce-${nonce}' blob: https://jerenyon.dev https://www.jerenyon.dev https://*.jerenyon.dev https://www.google.com https://www.gstatic.com https://app.termageddon.com https://privacy-proxy.usercentrics.eu https://app.usercentrics.eu https://vercel.live https://vercel.live/_next-live/feedback;
