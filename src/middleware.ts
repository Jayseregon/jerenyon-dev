...
function cspMiddleware(req: NextRequest): NextResponse {
  ...
  connect-src 'self' https://app.termageddon.com https://privacy-proxy.usercentrics.eu https://app.usercentrics.eu https://api.usercentrics.eu https://vercel.live https://jerenyon-dev-remote-pull.b-cdn.net https://unpkg.com https://fonts.gstatic.com wss://ws-us3.pusher.com;
  object-src 'none';
