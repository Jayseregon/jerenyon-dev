  ...
  return (
    <Card className="bg-background rounded-lg shadow-lg border border-purple-800 dark:border-purple-300 mb-8 mt-5 w-full">
      ...
      <CardBody className="p-6">
        <p className="text-justify mx-auto text-xl max-w-md text-purple-800 dark:text-purple-300">
          {tier.subtitle}
        </p>
          ...
          <div key={index} className="mb-6">
            ...
            <ul className="list-none mt-3 space-y-2">
              {section.whats_included.map((item, idx) => (
                <li
                  key={idx}
                  className="flex items-center text-md text-gray-800 dark:text-neutral-300"
                >
                  <CheckIcon
                    className="text-purple-800 dark:text-purple-300 mr-2"
                    size={20}
                  />
                  {item}
                </li>
