...
export const AwardCertificatIcon = ({ size = 10, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    focusable="false"
    height={size}
...
export const SchoolBackpackIcon = ({ size = 10, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    focusable="false"
    height={size}
...
export const LaptopIcon = ({ size = 10, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    focusable="false"
    height={size}
