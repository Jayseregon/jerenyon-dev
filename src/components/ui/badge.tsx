...
const badgeVariants = cva(
  ...
  "inline-flex items-center border text-xs transition-colors focus:outline-hidden",
  {
    variants: {
      variant: {
        default:
          "border-transparent rounded-md bg-slate-900 text-slate-50 shadow-sm hover:bg-slate-900/80 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50/80",
        secondary:
        ...
        destructive:
          "border-transparent rounded-md bg-red-500 text-slate-50 shadow-sm hover:bg-red-500/80 dark:bg-red-900 dark:text-slate-50 dark:hover:bg-red-900/80",
