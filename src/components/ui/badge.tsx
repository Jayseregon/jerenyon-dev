  ...
  "inline-flex items-center rounded-md border border-slate-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 dark:border-slate-800 dark:focus:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        purple:
          "bg-transparent border border-purple-500 mx-0.5 text-purple-500 rounded-full px-2 py-1",
        cyan: "bg-transparent border border-cyan-500 mx-0.5 text-cyan-500 rounded-full px-2 py-1",
        amber:
          "bg-transparent border border-amber-500 mx-0.5 text-amber-500 rounded-full px-2 py-1",
        gray: "bg-transparent border border-gray-500 mx-0.5 text-gray-500 rounded-full px-2 py-1",
      },
    },
    defaultVariants: {
      variant: "default",
